...
import click
import logging
from flexibill.app.utils.logging import ColorFormatter, request_msg_format
...
class TestColorFormatter:
    ...
    @mock.patch("flexibill.app.utils.logging.click.style",
    ...
    @mock.patch("flexibill.app.utils.logging.logging.Formatter")
